...
def func_H2_consumption_by_sector(file_path_scen,file_path_ref, run_name_scen,run_name_ref, output_folder):
    ...
    H2_cons_ref = H2_cons_ref[(H2_cons_ref['2'] != 'GlbMarket_HH2') & (H2_cons_ref['2'] != 'H2_STG')]
    H2_cons_ref['group'] = H2_cons_ref['2'].astype(str).str.cat(H2_cons_ref['3'].astype(str), sep='_')
    ...
    H2_cons_scen = H2_cons_scen[(H2_cons_scen['2'] != 'GlbMarket_HH2') & (H2_cons_scen['2'] != 'H2_STG')]
    H2_cons_scen['group'] = H2_cons_scen['2'].astype(str).str.cat(H2_cons_scen['3'].astype(str), sep='_')
    ...
    pivot_df = H2_cons_ref.pivot(index='3', columns='2', values='MtH2')
    ...
    pivot_df = H2_cons_scen.pivot(index='3', columns='2', values='MtH2')
    ...
    def plot_stacked_bars_with_differentiation(df1, df2):
        ...
        ax.set_title('Consumption by sector', fontsize=22)
